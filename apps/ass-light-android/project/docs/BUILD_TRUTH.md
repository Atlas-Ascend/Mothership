...
- Android compilation, lint, signing, APK/AAB structure, package metadata, emulator installation, launcher start, foreground service start/stop, and instrumented playback and Portal Seal tests.
